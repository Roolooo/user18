...
public class UserController {
	...
	BuyerService buyerservice;
	 ...
	 @PatchMapping(value="/buyer/{buyerid}")
...
//	    	}
	 ...
	 @PostMapping(value = "/buyer/reorder/{buyerid}/{prodid}/{availrpts}", produces = MediaType.APPLICATION_JSON_VALUE)
		public String doReorder(@PathVariable int buyerid,@PathVariable int prodid,@PathVariable boolean availrpts,@RequestBody String address) {
...
//	    	}
	       ...
	       storingOrder.setAddress(address);
	       storingOrder.setAmount(totalAmount);
	       res+=new RestTemplate().postForObject("http://localhost:8500/order",storingOrder,String.class);
	 ...
	 @PatchMapping(value="/seller/{sellerid}")
...
////Connecting with Plan Microservice//CREATED
//PlanDTO planDTO= new RestTemplate().getForObject("http://localhost:8004/plans/"+custDTO.getCurrentPlan().getPlanId(),PlanDTO.class);
////CREATED
//custDTO.setCurrentPlan(planDTO);
//List<Long>friends= new RestTemplate().getForObject("http://localhost:8003/customers/"+phoneNo+"/friends",List.class);
//custDTO.setFriendFamily(friends);
